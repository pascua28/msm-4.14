 ...
 **  Rui.Tuo        2019/11/19     add 6250 platform support
 ************************************************************************************/
...
#elif CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6250
...
|| CONFIG_OPPO_BSP_SECCOM_PLATFORM == 7150 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6250 \
|| CONFIG_OPPO_BSP_SECCOM_PLATFORM == 7250 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 8250
/* sdm660, sdm845, sdm670, sdm710, sdm855 sm6125 sm7150 sm6250 sm7250 sm8250*/
...
|| CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6250 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 7250 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 8250
